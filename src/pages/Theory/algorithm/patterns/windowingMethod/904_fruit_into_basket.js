...
var totalFruit = function (fruits) {
  ...
  /**
   * В lenType2 будем считать сколько фруктов этого типа мы встречали, прежде чем
  ...
  for (let end = 1; end < fruits.length; end++) {
     ...
     * если фрукт по текущей итерации не равен первому и второму типу, а так же -1.
     *
     * Вычислим максимальную длину сравнив длину текущего окна и максимальной длины
     *
     * Ообновим длину текущего окна путём присвоения значения длины второго типа фруктов + 1
    ...
    /**
     * Если текущий фрукт равен фрукту типа 1 , то увеличим счётчик длины типа2 на 1
     */
    if (fruits[end] == type1) {
      lenType2++;
    } else {
